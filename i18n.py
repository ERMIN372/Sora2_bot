...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "ru": {
        ...
        "start.welcome": (
            "✨ <b>Добро пожаловать в мир нейро-контента!</b>\n\n"
            "Здесь ты можешь создавать видео и изображения "
            "с помощью самых мощных нейросетей планеты — "
            "в пару кликов, прямо из Telegram.\n\n"
            "🖼 <b>Фото за копейки</b>\n"
            "├ 🍌 Nano Banana — <b>5 ₽</b>\n"
            "└ 🌄 DALL·E 3 — <b>5 ₽</b>\n\n"
            "🎬 <b>Премиум-видео</b>\n"
            "├ ☁️ Sora 2 — от <b>99 ₽</b>\n"
            "├ 🎭 Kling Motion Control — <b>110 ₽</b>\n"
            "├ 💚 Veo 3 — <b>89 ₽</b>\n"
            "└ 💎 Veo 3.1 — <b>299 ₽</b>\n\n"
            "💬 <b>AI-чат</b> — GPT-4.1 ответит на любой вопрос\n"
            "🔮 <b>Таро</b> — интерактивный расклад от нейросети\n\n"
            "🎁 Пополняй от 300 ₽ и получай <b>до +15% бонусных</b> кредитов!\n\n"
            "👇 <b>Жми кнопку ниже, чтобы сгенерировать свой первый шедевр!</b>"
        ),
        "start.welcome_referred": (
            "✨ <b>Добро пожаловать в мир нейро-контента!</b>\n\n"
            "🤝 <i>Вижу, ты пришёл от друга! Добро пожаловать в клуб.</i>\n\n"
            "Здесь ты можешь создавать видео и изображения "
            "с помощью самых мощных нейросетей планеты — "
            "в пару кликов, прямо из Telegram.\n\n"
            "🖼 <b>Фото за копейки</b>\n"
        ...
        "status.delivery_image_generic": "Не удалось отправить фото. Мы вернули кредиты — попробуйте позже.",
