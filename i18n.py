...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "ru": {
        ...
        "video.get.usage": "Использование: /video_get <job_id> [asset_id]",
        "video.get.missing_job_id": "Укажите job_id задачи.",
        "video.get.job_not_found": "Задача не найдена в журнале.",
        "video.get.access_denied": "У вас нет доступа к этой задаче.",
        "video.get.missing_video_id": "Для задачи нет video_id. Укажите его явно: /video_get <job_id> <asset_id?> <video_id>",
        "video.get.queued": "Скачивание поставлено в очередь. Ожидайте файл в чате.",
